    ...
    def burbuja_menor(self,datos:list)->None:
        ...
        for i in range(n-1):#ciclo de iteraciones
            for j in range(n-1,i,-1):#ciclo de comparaciones
                # define el ciclo interno que se ejecuta desde n-1 (el índice del último 
                # elemento del arreglo) hasta i (la posición actual del ciclo externo) 
                # en orden inverso (con un paso de -1).
